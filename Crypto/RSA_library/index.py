...
# Generate the private exponent from two "N" with the same factor.
def common_factor(e,n1,n2):
    return common_factor.getkey(e,n1,n2)


# Generate the private exponent from the "N" with factors that they have especially close value.
...
def low_E_attack(c, e, n):
    low_public_exponent_attack.decrypt()